...
│   │   ├── ai-action.types.ts   # ActionType enum (13 types), AiActionResult, AiActionError
...
| `priority_ranking` | `Array<{ id, module, featureName, description, priority, priorityReason, ... }>` |
| `scope_out_of_scope` | `{ content: string }` |
