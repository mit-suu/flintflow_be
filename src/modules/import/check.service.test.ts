...
const EXCLUDED = ["array_empty", "section_stale_at_baseline", "section_awaiting_reaccept", "screen_pending_at_baseline", "non_english_content", "usecase_no_function", "usecase_name_style"]
...
describe("hồ sơ luật mode 1", () => {
  it("cấu hình một chỗ: 7 luật loại trừ, 2 luật hạ mức, đều là luật có thật", () => {
